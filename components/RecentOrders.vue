<template>
  <div class="mt-5">
    <p class="font-bold">Pedidos recentes</p>
      ...
      <table class="w-full border-collapse">
        <thead>
          <tr class="border-b text-left text-xs">
            <th class="p-4 font-medium uppercase text-muted-foreground">produtos</th>
            <th class="p-4 font-medium uppercase text-muted-foreground">Pagamento</th>
        ...
        <tbody>
          <tr v-for="n in 6" class="border-b text-left text-sm last:border-b-0 hover:bg-muted">
            <td class="p-4">Tênis Nike</td>
            <td class="p-4">Pago</td>
            <td class="p-4">Enviado</td>
            <td class="p-4">
